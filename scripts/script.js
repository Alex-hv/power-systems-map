...
var w = 1600;
var h = 799;
//подганяю карту к размерам экрана
...
for (var i = 0; i < coords15New.length; ++i) {
	...
	$('#area9, #popover3').hover(function(){light(9)},function(){dark(9,"rose")});
	$('#area10, #popover3').hover(function(){light(10)},function(){dark(10,"rose")});
	$('#area11, #popover3').hover(function(){light(11)},function(){dark(11,"rose")});
	$('#area12, #popover3').hover(function(){light(12)},function(){dark(12,"rose")});
	$('#area13, #popover3').hover(function(){light(13)},function(){dark(13,"rose")});
	$('#area14, #popover3').hover(function(){light(14)},function(){dark(14,"rose")});
	$('#area15, #popover3').hover(function(){light(15)},function(){dark(15,"rose")});

}
//ф-я подсветки области
function light(num){
