...
//размеры экрана, при которых задавались базовые области и переменные для попапа
var w = 1600;
var h = 799;
var number;
var color;
...
function NewSize(){
	...
	if (!is_touch_device()){//для не-тач экранов
...
function light(num,col){
	...
	//наполняю контент
	var list = JSON.parse(getData(num));
	var content='';
	for(var key in list){
		content += ("<b>" + key +"</b>" + ": "+ list[key]+'<br>');
...
function getData(num){
	return '{ "Данные0": "данные", "Данные1": "данные", "Данные2": "данные", "Данные3": "данные", "Данные4": "данные", "Данные5": "данные", "Данные6": "данные", "Данные7": "данные", "Данные8": "данные", "Данные9": "данные"}';
}
